export const SampleWalletAbi = {
  ...
  functions: [
    {
      name: 'constructor',
      inputs: [{ name: '_ellipticCurve', type: 'address' }],
      outputs: [],
    },
    {
    ...
    },
    {
      ...
      outputs: [{ name: 'remainder', type: 'uint256' }],
    },
    {
      name: 'modAdd',
      inputs: [
    ...
    },
    {
      ...
      inputs: [{ name: 'scalar', type: 'uint256' }],
      outputs: [
        { name: 'value0', type: 'uint256' },
        { name: 'value1', type: 'uint256' },
      ],
